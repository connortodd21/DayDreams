...
describe('Test Delete Circle', () => {
    ...
    describe('Delete circle without circle id', () => {
    ...
    describe('Delete circle with invalid auth', () => {
    ...
    describe('Delete circle with correct info', () => {
